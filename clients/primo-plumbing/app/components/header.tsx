...
function Logo() {
  return (
    <Link href="#" className="flex items-center gap-2.5">
      ...
      <span className="font-serif text-lg font-bold text-gray-900 tracking-tight">Primo Plumbing</span>
    </Link>
  )
}
...
function PhoneLink({ className = '' }: { className?: string }) {
  return (
    <a href="tel:+15098228299" className={`inline-flex items-center gap-2 font-semibold text-gray-900 hover:text-[var(--color-primary)] transition-colors ${className}`}>
