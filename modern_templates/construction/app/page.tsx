...
const PROJECTS = [
  { title: 'Kitchen Remodel', src: '/images/projects/kitchen.jpg', alt: 'Modern kitchen renovation', category: 'Remodeling' },
  { title: 'Commercial Building', src: '/images/projects/building.jpg', alt: 'Commercial building project', category: 'Commercial' },
  { title: 'Home Addition', src: '/images/projects/home.jpg', alt: 'Home exterior addition', category: 'Additions' },
  { title: 'Bathroom Renovation', src: '/images/projects/bathroom.jpg', alt: 'Bathroom remodel', category: 'Remodeling' },
]
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Divider between Services and Reputation — options: A=line+dot (current), B=background shift, C=short tagline band, D=dashed rule */}
        ...
        <section className="relative py-20 md:py-24 overflow-hidden" aria-label="Section divider">
          <div className="absolute inset-0">
            <Image
              src="/images/projects/building.jpg"
              alt=""
              fill
              className="object-cover"
              sizes="100vw"
